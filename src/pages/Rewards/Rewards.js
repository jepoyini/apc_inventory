...
const DonationOrderHistory = () => {
  document.title = "Transactions | IBO Mastermind";
  ...
  const fetchRows = async (page, limit) => {
    try {
      ...
      const response = await api.post("/rewardlist", payload);
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Reward Points" pageTitle="Dashboard" url="/dashboard" />
                  ...
                  <CardBody>
                      <div className="d-flex align-items-center">
                          <div className="flex-grow-1 overflow-hidden">
                              <p className="text-uppercase fw-medium text-muted text-truncate mb-0">Point Balance</p>
                          </div>
          ...
          <Col lg={12}>
            <Card id="TransactionsList">
                              <CardHeader className="">
                                <div className="d-flex align-items-center">
                                  <h5 className="card-title mb-0 flex-grow-1">Reward Points Transaction</h5>
                                  <div className="flex-shrink-0">
