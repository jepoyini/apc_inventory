...
//                     uid:1
//                 };
//                 const response = await axios( "https://api.billiondollarmind.io/test.php",data );
...
useEffect(() => {
    ...
    if (queryreferrer && queryreferrer.toLowerCase() !== "login") {
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mt-4">
                                                    ...
                                                    type="submit">
                                                        { buttonloading ? <Spinner size="sm" className='me-2'> Loading... </Spinner> : "Sign In"}
