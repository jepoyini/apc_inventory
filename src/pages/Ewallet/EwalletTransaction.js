...
const DonationOrderHistory = () => {
  document.title = "E-wallet Transactions | IBO Mastermind";
  ...
  const [ewalletbalance, setTotalBalance] = useState(0);  
  ...
  const fetchRows = async (page, limit) => {
    try {
      ...
      const response = await api.post("/ewalletlist", payload);
      ...
      if (response && response.success && Array.isArray(response.orders)) {
        ...
        setTotalBalance(response.ewalletbalance)
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="E-wallet Transactions" pageTitle="Dashboard" url="/dashboard" />
          ...
          <Col lg={12}>
            <Card id="TransactionsList">
                              <CardHeader className="">
                                <div className="d-flex align-items-center">
                                  <h5 className="card-title mb-0 flex-grow-1">E-wallet Transaction</h5>
                                  <div className="flex-shrink-0">
